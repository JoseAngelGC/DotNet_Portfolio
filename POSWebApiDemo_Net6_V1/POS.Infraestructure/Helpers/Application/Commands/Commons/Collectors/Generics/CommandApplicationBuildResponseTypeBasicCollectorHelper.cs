...
using POS.Infraestructure.Helpers.Application.Commands.Commons.Collectors.Generics.Bases;
...
namespace POS.Infraestructure.Helpers.Application.Commands.Commons.Collectors.Generics
{
    public class CommandApplicationBuildResponseTypeBasicCollectorHelper<T> : BaseCommandApplicationBuildResponseTypeBasicCollectorHelper<T> where T : CommandInteractorResponseDto
    {
