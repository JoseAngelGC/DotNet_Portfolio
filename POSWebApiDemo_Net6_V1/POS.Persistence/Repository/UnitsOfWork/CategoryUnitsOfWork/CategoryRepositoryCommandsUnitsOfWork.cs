...
using POS.Persistence.Repository.CategoryRepository.Queries.ExistItem;
...
{
    public class CategoryRepositoryCommandsUnitsOfWork<T> : ICategoryRepositoryCommandsUnitsOfWork<T> where T : BaseEntity
    {
        ...
        public IExistCategoryItemByName ExistCategoryItemByName { get; private set; }
        public IExistCategoryItemById ExistCategoryItemById { get; private set; }

        public CategoryRepositoryCommandsUnitsOfWork(POSContext context)
        {
            _context = context;
            ...
            ExistCategoryItemByName = new ExistCategoryItemByName<Category>(_context);
            ExistCategoryItemById = new ExistCategoryItemById<Category>(_context);
        }
