...
{
    internal class ExceptionCommandResponseBasicHelper : BaseExceptionCommandResponseHelper
    {
        public override async Task<CommandResponseDto> AttributesValuesAsync(string? messageErrorException, int? hResultException, string? sourceException)
        {
