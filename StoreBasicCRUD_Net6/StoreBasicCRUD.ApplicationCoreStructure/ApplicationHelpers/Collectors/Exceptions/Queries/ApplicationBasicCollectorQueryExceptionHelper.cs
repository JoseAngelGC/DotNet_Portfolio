...
using StoreBasicCRUD.ApplicationCoreStructure.ApplicationHelpers.Collectors.Exceptions.Queries.Bases;
using StoreBasicCRUD.Utilities.Shared.Consts;

namespace StoreBasicCRUD.ApplicationCoreStructure.ApplicationHelpers.Collectors.Exceptions.Queries
{
    public class ApplicationBasicCollectorQueryExceptionHelper : BaseApplicationCollectorQueryExceptionHelper
    {
        public override async Task<ApplicationCollectorQueryResponseEntity<T>> ResponseAsync<T>(string? messageErrorException, int? hResultException, string? sourceException)
        {
